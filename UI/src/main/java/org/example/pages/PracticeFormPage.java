...
public class PracticeFormPage extends BasePage {
    ...
    public PracticeFormPage selectState() {
        elementActions.clickElement(inputState);
    ...
    public PracticeFormPage selectSubject() {
        elementActions.clickElement(subjects);
    ...
    public PracticeFormPage checkStudentDetails(Student student) throws InterruptedException {
